...
%Relate our hardware implementation to hardware impl. of heaps
%Maybe as an alternate design after introducing the context of shared-memory routers
...
We can handle LIFO by creating a new flow for every packet, so long as there are
fewer than 1024 packets (flows) in the buffer at any time.}} \eg based on
