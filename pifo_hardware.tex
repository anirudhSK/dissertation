...
\begin{figure}[!t]
  \centering
  \includegraphics[width=\columnwidth]{PIFO_figures/pifo_impl.pdf}
...
\begin{figure}[!t]
  \centering
  \includegraphics[width=\columnwidth]{PIFO_figures/flow_scheduler_hardware.pdf}
...
\begin{figure}[!t]
  \centering
  \includegraphics[width=0.9\columnwidth]{PIFO_figures/2stage_pipeline.pdf}
