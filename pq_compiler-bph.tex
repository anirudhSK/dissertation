...
%% How to get \TheSystem aggregation functions to run on router hardware? These
%% functions involve updates to state on the router, where the updates are encoded
%% in the form of assignments (\ie {\ct x = ...})  and branches (\ie {\ct if pred
%%   {...} else {...}}). Prior work as part of the Domino
%% language studies how to take such programs and configure a
