...
%resume here ...
\Para{Determining history of variables.} We now describe \Alg{history} that
...
instance, in \Fig{running-example-code}, right after it is assigned, {\ct
...
\ie {\ct if (predicate) \{...\}} statements, we generalize this observation. A
