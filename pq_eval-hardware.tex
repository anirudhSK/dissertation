...
%
%% Atoms are processing units or ALUs representing a programmable router's
%% instruction set.
%
%% An atom models an atomic unit of computation provided natively by a
%% programmable router and can implement either a stateless (\eg incrementing a
%% packet field) or stateful (\eg incrementing a router counter) computation.
...
%can easily fit on a router~\cite{domino_sigcomm}.
