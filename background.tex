...
%TODO: Compare against fast in Domino chapter?
...
would have allowed. Open Virtual Switch~\cite{openvswitch} was probably the
most well-known example of an edge router. More recently, increasing
performance requirements on the edge have led to moving the functionality of
such virtual switches on to an FPGA~\cite{daniel_firestone_nsdi}.
