...
\begin{table}[!t]
\begin{small}
  \begin{tabular}{|p{0.15\columnwidth}|p{0.34\columnwidth}|p{0.12\columnwidth}|p{0.09\columnwidth}|p{0.09\columnwidth}|p{0.07\columnwidth}|p{0.04\columnwidth}|}
\hline
Algorithm & Stateful operations & Most expressive atom required & \# of stages, max. atoms/stage & Ingress or Egress Pipeline? & Domino LOC & P4 LOC\\
\hline
