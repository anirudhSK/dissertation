...
\hline
Bloom filter (3 hash functions) & Test/Set membership bit on every packet. & Read/Write & 4, 3 & Either & 29 & 104 \\
\hline
...
%\hline
CoDel~\cite{codel} & Update whether we are marking or not, time for next mark, number of marks so far, and time at which minimum queueing delay will exceed target. & Doesn't map & 15, 3 & Egress & 57 & 271\\
\hline
\end{tabular}
\end{small}
...
of a 200 \si{\milli\metre\squared} baseline switching chip~\cite{gibb_parsing},
