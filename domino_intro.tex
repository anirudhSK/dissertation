...
%\label{s:intro}
Network routers in modern datacenters, enterprises, and service-provider
...
data-plane and control-plane mechanisms. This chapter focuses on data-plane
...
management~\cite{red,avq,codel}, packet scheduling~\cite{wfq, pfabric}, congestion
...
routers~(\S\ref{s:absmachine}).  \absmachine models two important constraints
