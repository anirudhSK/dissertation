...
%TODO: Commenting out parsing, header processing, scheduling etc.
...
% alone.
In this chapter, we propose {\em language-directed hardware design}: we design a
...
and future performance monitoring needs. Specifically, we make three contributions.
