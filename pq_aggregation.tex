...
notation (\S\ref{ss:notation} and \S\ref{ss:closure}) before presenting our
formal results (\S\ref{ss:proofs}).
...
We use the notation $f(s, \{p_1, \ldots p_k\})$ to denote the composition of
$f$ over a sequence of packets. Additionally, we say that a merge function
successfully merges an aggregation function if
Equation~\ref{eqn:merge_condition} holds. 
