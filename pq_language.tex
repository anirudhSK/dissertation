...
%% decides that a tuple containing the current value of the state (\ie flowlet
...
processed from the same original packet tuple (\ie {\ct pktstream}). A {\ct zip} is a special kind of
