...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{atom.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{packet_transaction.pdf}
...
Packet transactions provide the semantics that any visible state
