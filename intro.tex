%TODO: Justify why the evaluation metrics make sense.
%Why are we measuring area, expressiveness, etc?
%Clarify that the goal here is not to improve performance, but a future-proof
