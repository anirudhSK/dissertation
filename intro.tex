...
packets with a small program to assign each packet its priority.\foonote{We use
...
%TODO: Need to specify somewhere that this is a network-wide programming model
