...
router chips. However, more work must be done before packet transactions
...
further work. When a router executes multiple transactions,
...
for router designers. For instance, given a corpus of data-plane algorithms,
