...
%TODO: Expand on tac here?
%TODO: PVSM might be excessive here. Consider simplifying.
...
\Para{Converting to static single-assignment form.} We next convert the code
...
\Para{Flattening to three-address code.} Three-address code is a
...
\eg {\tt pkt.tmp2} in Figure~\ref{fig:three_address}.
...
%TODO: Does it actually make the mapping problem easier?
