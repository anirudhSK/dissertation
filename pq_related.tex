...
\Para{Programmable routers.} \TheSystem builds on programmable router
...
%%\TheSystem shares the vision of developing new monitoring router primitives with
%%the prior work of Nelson~\etal~\cite{stateful-router-monitoring}. The semantic
%%router features they propose pertain to stateful properties of network
...
%% kinds of router monitoring we want and (ii) developing an efficient
