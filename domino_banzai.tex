...
Packets arriving at a switch~(top half of Figure~\ref{domino_fig:switch}) are parsed
...
\absmachine (the bottom half of Figure~\ref{domino_fig:switch}) models
