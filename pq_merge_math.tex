...
\title{Understanding mergeability}
...
This document is a supplement to the 2017 SIGCOMM submission entitled
``Language-Directed Hardware Design for Network Performance Monitoring'',
providing proofs for the theorems outlined in Section 4.4.
...
\begin{theorem}[Submission Theorem 4.1]
...
\begin{theorem}[Submission Theorem 4.2]
...
\begin{theorem}[Submission Theorem 4.3]
...
\begin{theorem}[Submission Theorem 4.4]
...
\begin{theorem}[Submission Theorem 4.5]
